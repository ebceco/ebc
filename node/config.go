...
import (
	...
	"github.com/ebceco/ebc/accounts/usbwallet"
...
type Config struct {
	...
	// used in the devp2p node identifier. The instance name of geth is "ebc". If no
...
// These resources are resolved differently for "ebc" instances.
