...
import (
	...
	"github.com/ebceco/ebc/internal/build"
	"github.com/ebceco/ebc/params"
	sv "github.com/ebceco/ebc/swarm/version"
)
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "-ldflags", "-s -w", "--target", "android", "--javapkg", "org.ethereum", "-v", "github.com/ebceco/ebc/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "-ldflags", "-s -w", "--target", "ios", "--tags", "ios", "-v", "github.com/ebceco/ebc/mobile")
